...
public class HouseLoadingView extends View {
    ...
    private void drawProgress(Canvas canvas) {
        ...
        mProgressWidth = (int) (mTotalWidth * 3 / 5f);
        // 当前进度算出进度条的位置
        ...
        } else if (mCurrentProgressPosition >= mProgressWidth + 30) {
            //draw left
            drawLeft(canvas, 30);
            //draw center
    ...
    private void drawChimney(Canvas canvas) {
        ...
        RectF rectSecond = new RectF(left2 + shift2, top2 - 4 * shift2 / 3, right2 + 3 * shift2 / 2,
                bottom2 - shift2);
    ...
    private void drawRight(Canvas canvas, int mCurrentProgressPosition) {
        ...
        int height = (int) Math.sqrt(900 - (mCurrentProgressPosition - mProgressWidth + 30) *
                (mCurrentProgressPosition - mProgressWidth + 30));
        //上圆弧
    ...
    private void drawCenter(Canvas canvas, int mCurrentProgressPosition) {
        ...
        mPaint.setStyle(Paint.Style.FILL);
        RectF mRect = new RectF();
        mRect.left = mTotalWidth * HouseValuse.pro_pading_rat + 30;
        mRect.top = mTotalHeight / 2 + 105;
        mRect.right = mCurrentProgressPosition + 200;
        mRect.bottom = mRect.top + HouseValuse.pro_hight - 5;
        canvas.drawRect(mRect, mPaint);
    }
    ...
    private void drawBackground(Canvas canvas) {
        ...
        progressRect.left = mTotalWidth * HouseValuse.pro_pading_rat;
        progressRect.top = mTotalHeight / 2 + 100;
        progressRect.right = mTotalWidth * (1 - HouseValuse.pro_pading_rat);
        progressRect.bottom = progressRect.top + HouseValuse.pro_hight;
    ...
    private void drawRoundRect(Canvas canvas) {
        ...
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(5);          //画笔粗细设置
        RectF progressRect = new RectF();
        progressRect.left = mTotalWidth * HouseValuse.pro_pading_rat;
        progressRect.top = mTotalHeight / 2 + 100;
        progressRect.right = mTotalWidth * (1 - HouseValuse.pro_pading_rat);
